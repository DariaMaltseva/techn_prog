...
namespace WcfServiceLibrary1
{
    ...
    public class Cost : SCost
    {
        ...
        public string Cost_Old_Product
        {
            get
            {
                return Old_Product;
        ...
        public string Cost_New_Product
        {
            get
            {
                return New_Product;
        ...
        public string getByName(string product)
        {
            ...
            string SQL = "SELECT \"Old_Product\", \"New_Product\", \"Old_cost\".\"New_cost\", \"Date_C\" FROM \"Cost\" and \"Product\" = @product;";
            ...
            try
            {
                ...
                if (i > 0 && reader.HasRows)
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        {
                            mas[cell, row] = Regex.Replace(Convert.ToString(reader.GetValue(cell)), "[ ]+", " ");
                            Old_Product = Regex.Replace(Convert.ToString(reader.GetValue(0)), "[ ]+", " ");
                            New_Product = Regex.Replace(Convert.ToString(reader.GetValue(0)), "[ ]+", " ");
        ...
        {
            return Old_Product + " " + New_Product + " " + Old_cost + " " + New_cost + " " + Date_C;
        }
    }
}
