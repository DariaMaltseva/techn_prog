...
namespace WcfServiceLibrary1
{
    ...
    public class Factory : SFactory
    {
        ...
        public string getByName(string name)
        {
            ...
            NpgsqlConnection conn = new NpgsqlConnection("Server=localhost;Port=5433;User Id=postgres;Password=qwer;Database=TP_3;");
            NpgsqlCommand command = new NpgsqlCommand();
            string SQL = "SELECT \"Factory\".\"Name\",  \"Factory\".\"Address\",  \"Country\".\"Name\" AS Country FROM \"Factory\", \"Country\" WHERE  \"Factory\".\"Is_del\"=0 and  \"Factory\".\"ID_Country\" =  \"Country\".\"ID\" and \"Factory\".\"Name\",  \"Factory\".\"Address\",  \"Factory\".\"Name\" = @name;";
            command.CommandText = SQL;
            command.Parameters.AddWithValue("@name", name);
            command.Connection = conn;
            NpgsqlDataReader reader = null;
