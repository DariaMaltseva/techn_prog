...
namespace WcfServiceLibrary1
{
    ...
    public class Sup_Journal : SSup_Journal
    {
        ...
        public string get()
        {
            ...
            NpgsqlConnection conn = new NpgsqlConnection("Server=localhost;Port=5433;User Id=postgres;Password=qwer;Database=TP_3;");
            NpgsqlCommand command = new NpgsqlCommand("SELECT \"Product\".\"Name\" AS Product, \"Shop\".\"Name\" AS Shop, \"Supplies_Journal\".\"Supply_date\" FROM \"Supplies_Journal\", \"Product\", \"Shop\" WHERE \"Supplies_Journal\".\"Is_del\"=0 and \"Supplies_Journal\".\"ID_Product\" = \"Product\".\"ID\" and \"Supplies_Journal\".\"ID_Shop\"=\"Shop\".\"ID\"", conn);
            NpgsqlDataReader reader = null;
            try
            {
                conn.Open();
