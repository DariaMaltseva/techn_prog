...
namespace WcfServiceLibrary1
{
    ...
    public class Employee : SEmployee
    {
        ...
        public void Insert()
        {
            ...
            NpgsqlConnection conn = new NpgsqlConnection("Server=localhost;Port=5433;User Id=postgres;Password=qwer;Database=TP_3;");
            NpgsqlCommand command = new NpgsqlCommand();
            string SQL = "INSERT INTO \"Employee\"(\"Name\", \"Salary\", \"ID_Factroy\", \"ID_Position\", Is_del) VALUES(@name, @salary, @id_factory, @id_position, 0);";
            ...
            command.Parameters.AddWithValue("@id_factory", id_position);
        ...
        public void Update(string newname)
        {
            NpgsqlConnection conn = new NpgsqlConnection("Server=localhost;Port=5433;User Id=postgres;Password=qwer;Database=TP_3;");
            NpgsqlCommand command = new NpgsqlCommand();
            string SQL = "UPDATE \"Employee\" SET \"Name\" = @newname, \"Salary\" = @salary, \"ID_Factory\" = @id_factory, \"ID_Position\" = @id_position WHERE \"Name\" = @name;";
            command.CommandText = SQL;
            string id_factory = GetFactoryID(Factory);
            string id_position = GetPositionID(Position);
        ...
        public string get()
        {
            ...
            NpgsqlConnection conn = new NpgsqlConnection("Server=localhost;Port=5433;User Id=postgres;Password=qwer;Database=TP_3;");
            NpgsqlCommand command = new NpgsqlCommand("SELECT \"Employee\".\"Name\", \"Position\".\"Name\", \"Factory\".\"Name\" FROM \"Employee\", \"Position\", \"Factory\" WHERE \"Employee\".\"Is_del\"=0 and \"Employee\".\"ID_Position\" = \"Position\".\"ID\" and \"Employee\".\"ID_Factory\"=\"Factory\".\"ID\"", conn);
            NpgsqlDataReader reader = null;
            try
            {
                conn.Open();
        ...
        public string getByName(string name)
        {
            ...
            NpgsqlConnection conn = new NpgsqlConnection("Server=localhost;Port=5433;User Id=postgres;Password=qwer;Database=TP_3;");
            NpgsqlCommand command = new NpgsqlCommand();
            string SQL = "SELECT \"Employee\".\"Name\", \"Position\".\"Name\", \"Factory\".\"Name\" FROM \"Employee\", \"Position\", \"Factory\" WHERE \"Employee\".\"Is_del\"=0 and \"Employee\".\"ID_Position\" = \"Position\".\"ID\" and \"Employee\".\"ID_Factory\"=\"Factory\".\"ID\" and \"Name\" = @name;";
            command.CommandText = SQL;
            command.Parameters.AddWithValue("@name", name);
            command.Connection = conn;
            NpgsqlDataReader reader = null;
                ...
                if (i > 0 && reader.HasRows)
                {
                    ...
                    while (reader.Read())
                    {
                        for (int cell = 0; cell < i; cell++)
                        {
                            ...
                            Factory = Regex.Replace(Convert.ToString(reader.GetValue(2)), "[ ]+", " ");
                            Position = Regex.Replace(Convert.ToString(reader.GetValue(3)), "[ ]+", " ");
                        }
                        row++;
                    }
                }
